/**
 * Error Handling Utilities for Figma MCP Server
 *
 * Custom error classes and error handling helpers.
 */

/**
 * Base Figma API error
 */
 ...
 * Not found error
 */
export class NotFoundError extends FigmaApiError {
 ...
 */
export class ForbiddenError extends FigmaApiError {
  constructor(message: string) {
